defmodule GraphqlSubscription.AuthTest do
  use GraphqlSubscription.DataCase

  alias GraphqlSubscription.Auth

  describe "users" do
    alias GraphqlSubscription.Auth.User

    import GraphqlSubscription.AuthFixtures
